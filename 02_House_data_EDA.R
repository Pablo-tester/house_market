...
# 1.1 Transform Date to a standard R date variable
...
# 1.2 Re-arrange variables

Average_priced <- Average_priced %>% 
                  select(
                         datef,
...
Price_changed <- Price_changed %>% 
                 select(
                        datef,
                        Chnge_price = Price_change
                 )
Price_changed


# 1.3 Plot average house prices
# Added color to main line
...
# 1.4 Plot annual change in house proces house prices
