...
# Latest available file: Figure_2__The_average_UK_house_price_was_£285,000_in_December_2023_(provisional_estimate).xls
excel_sheets("./data/03 ONS_House_prices/Ownership/Figure_2__The_average_UK_house_price_was_£285,000_in_December_2023_(provisional_estimate).xls")
...
House_priceavg <- House_price %>% 
                  select ( Date = month, avg_house_price = uk_average_house_price) %>% 
...
Housep_chart <- House_prices_chart %>% 
  ...
  labs(title = "ONS Average UK House prices",     # Include titles and subtitles and also X and Y Axis titles
       subtitle ="From January 2005 to December 2023",
...
ggsave("plots/35_ONS_Average_UK_House_prices_Jan2005_December2023_Annotated.png", width = 10, height = 6) 
